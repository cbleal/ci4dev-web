...
<head>
  ...
  <!-- Bootstrap CSS-->
  <link rel="stylesheet" href="<?= site_url('features/') ?>vendor/bootstrap/css/bootstrap.min.css">
  <!-- Font Awesome CSS-->
  <link rel="stylesheet" href="<?= site_url('features/') ?>vendor/font-awesome/css/font-awesome.min.css">
  <!-- Custom Font Icons CSS-->
  <link rel="stylesheet" href="<?= site_url('features/') ?>css/font.css">
  <!-- Google fonts - Muli-->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Muli:300,400,700">
  <!-- theme stylesheet-->
  <link rel="stylesheet" href="<?= site_url('features/') ?>css/style.default.css" id="theme-stylesheet">
  <!-- Custom stylesheet - for your changes-->
  <link rel="stylesheet" href="<?= site_url('features/') ?>css/custom.css">
  <!-- Favicon-->
  <link rel="shortcut icon" href="<?= site_url('features/') ?>img/favicon.ico">
...
<body>
  ...
  <!-- JavaScript files-->
  <script src="<?= site_url('features/') ?>vendor/jquery/jquery.min.js"></script>
  <script src="<?= site_url('features/') ?>vendor/popper.js/umd/popper.min.js"> </script>
  <script src="<?= site_url('features/') ?>vendor/bootstrap/js/bootstrap.min.js"></script>
  <script src="<?= site_url('features/') ?>js/front.js"></script>
