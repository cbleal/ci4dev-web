  ...
  <div class="col-lg-8">
    ...
    <div class="user-block block">
      <?php if (empty($gruposAvailables)) : ?>
        <?php if ($user->full_control) : ?>
          <p class="contributions text-white mt-0">Esse usuário pertence ao grupo Administrador, para associá-lo a outros grupos, é necessário removê-lo do grupo Administrador.</p>
        <?php else : ?>
            ...
            <tbody>
              <?php foreach ($user->grupos as $info) : ?>
                <tr>
                  ...
                  <td><?= esc($info->name) ?></td>
                  <td><?= ellipsize($info->description, 32) ?></td>
